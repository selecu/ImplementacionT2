...
namespace v1
{
    public class ScrollViewWords_segundo : MonoBehaviour
    {

        private RectTransform rect;

        public static ScrollViewWords_segundo instance;
        ...
        private void Awake()
        {
            ...
            WordHunt_segundo wh = WordHunt_segundo.instance;

            //rect.sizeDelta = new Vector2(rect.sizeDelta.x, (wh.cellSize.y + wh.cellSpacing.y) * wh.gridSize.y);
        }

        public void SpawnWordCell(string word, float delay, Sprite Image)
        {
            ...
            //cell.transform.DOScale(0, 0.01f).SetEase(Ease.OutBack).From().SetDelay(delay);
        }
        ...
        public void CheckWord(string word)
        {
            for (int i = 0; i < scrollViewContent.childCount; i++)
            {
                ...
                if (t.text.ToLower() == word || t.text.ToLower() == WordHunt_segundo.Reverse(word))
                {
                    HighlightBehaviour_segundo highlight = HighlightBehaviour_segundo.instance;
