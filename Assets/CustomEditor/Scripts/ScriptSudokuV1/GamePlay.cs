        ...
        void Start()
        {
            switch (GetDificultad)
            {
                ...
                case Dificultad.Facil:
                    {
                        sudoku = new Sudoku(Missing = UnityEngine.Random.Range(7, 10));
                    }
                    break;
                case Dificultad.Medio:
                    {
                        sudoku = new Sudoku(Missing = UnityEngine.Random.Range(18, 22));
                    }
                    break;
                case Dificultad.Dificil:
                    {
                        sudoku = new Sudoku(Missing = UnityEngine.Random.Range(40, 50));
                    }
                    break;
                case Dificultad.Experto:
                    {
                        sudoku = new Sudoku(Missing = UnityEngine.Random.Range(70, 80));
                    }
                    break;
            }
