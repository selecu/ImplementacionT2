...
namespace v1
{
	...
	public class PreguntaManagerTamgram : MonoBehaviour
	{


		public List<PiezaTangram> AllPiezas;
		...
		public void Instance()
		{
			...
			for (int i = 0; i < N; i++)
			{
				...
				g.transform.GetComponent<DragHandlerTamgram>().id = AllPiezas[i].id1;
