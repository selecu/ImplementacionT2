    ...
    public class ManagerVerificatorCardsreverse : MonoBehaviour
    {
        ...
        public void GetC1C2()
        {
            if (c1 == null && c2 == null)
            {
                ...
                c1.transform.GetChild(0).GetComponent<TMP_Text>().enabled = true;
            ...
            else if (c2 == null)
            {
                if (EventSystem.current.currentSelectedGameObject.gameObject != c1)
                {
                    ...
                    c2.transform.GetChild(0).GetComponent<TMP_Text>().enabled = true;
        ...
        IEnumerator esperar() {
            ...
            c1.transform.GetChild(0).GetComponent<TMP_Text>().enabled = false;
            c2.transform.GetChild(0).GetComponent<TMP_Text>().enabled = false;
            c1 = null;
            c2 = null;
    }
