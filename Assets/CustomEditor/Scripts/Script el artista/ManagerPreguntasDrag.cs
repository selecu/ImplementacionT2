...
{
    public class ManagerPreguntasDrag : MonoBehaviour
    {
		public List<ValuesDrag> AllPiezas;
		...
		public void Instance()
		{
			...
			for (int i = 0; i < N; i++)
			{
				...
				g.transform.GetComponent<DragAndDropManager>().id = AllPiezas[i].id1;
