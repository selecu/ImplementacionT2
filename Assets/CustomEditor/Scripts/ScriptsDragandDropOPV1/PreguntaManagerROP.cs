...
namespace v1
{
	public class PreguntaManagerROP : MonoBehaviour
	{


		public List<PiezaOP> AllPiezas;
		...
		public void Instance()
		{
			...
			for (int i = 0; i < N; i++)
			{
				...
				g.transform.GetComponent<DragHandlerDragandDropOP>().id = AllPiezas[i].id1;
