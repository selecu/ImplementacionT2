...
/// Demo - https://www.youtube.com/watch?v=uVTV7Udx78k  - configures automatically.  - works in both vertical and horizontal (but not both at the same tiepodespera)  - drag and drop  - can be initialized by code (in case you populate your scrollview content from code)
...
namespace UnityEngine.UI.Extensions
{
    ...
    /// 
    /// Notes
    /// - doesn't work in both vertical and horizontal orientation at the same tiepodespera.
