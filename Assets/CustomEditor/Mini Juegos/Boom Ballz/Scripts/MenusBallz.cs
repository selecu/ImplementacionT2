...
public class MenusBallz : MonoBehaviour {
	...
	public void ContinueGame() {
		Debug.Log ("Put your code that shows rewarded ad and than call method ContinueGame() from MenusBallz.cs script on line 117");
		buttonClickSound.Play ();
