            ...
            for (int i = 0; i < preguntas.Count; i++)
            {
                for (int e = 0; e < respuestas.Count; e++)
                {
                    if (preguntas[i].id == respuestas[e].id)
                    {
                        ...
                        respuestas[i].GetComponentInChildren<Text>().text = respuestaID.ToString();
                        preguntas[e].GetComponentInChildren<Text>().text = (sumando1.ToString() + simbolo + sumando2.ToString());
            ...
            for (int i = 0; i < preguntas.Count; i++)
            {
                for (int e = 0; e < respuestas.Count; e++)
                {
                    if (preguntas[i].id == respuestas[e].id)
                    {
                        ...
                        //preguntas[i].id = respuestaID.ToString();
                        //respuestas[e].id = respuestaID.ToString();
                        respuestas[i].GetComponentInChildren<Text>().text = respuestaID.ToString("F0");
                        preguntas[e].GetComponentInChildren<Text>().text = (sumando1.ToString() + simbolo + sumando2.ToString());
            ...
            for (int i = 0; i < preguntas.Count; i++)
            {
                for (int e = 0; e < respuestas.Count; e++)
                {
                    if (preguntas[i].id == respuestas[e].id)
                    {
                        ...
                        //preguntas[i].id = respuestaID.ToString();
                        //respuestas[e].id = respuestaID.ToString();
                        respuestas[i].GetComponentInChildren<Text>().text = respuestaID.ToString("F");
                        preguntas[e].GetComponentInChildren<Text>().text = (sumando1.ToString() + simbolo + sumando2.ToString());
