...
namespace I252MecPuntosRP3
{
    public class GameManagerPuntosr : MonoBehaviour
    {
        [SerializeField]
        GameObject check;
        [SerializeField]
